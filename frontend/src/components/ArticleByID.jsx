...
function ArticleByID() {
  ...
  useEffect(() => {
    ...
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(`https://capstone-project-ycw3.onrender.com/user-api/article/${id}`, { withCredentials: true });
  ...
  const toggleArticleStatus = async () => {
    ...
    try {
      const res = await axios.patch(
        "https://capstone-project-ycw3.onrender.com/author-api/articles",
  ...
  const addComment = async (commentObj) => {
    ...
    let res = await axios.put("https://capstone-project-ycw3.onrender.com/user-api/comment", commentObj, { withCredentials: true });
    if (res.status === 200) {
