...
function AdminProfile() {
  ...
  const fetchAdminData = async () => {
    ...
    try {
      const [usersRes, articlesRes] = await Promise.all([
        axios.get("https://capstone-project-ycw3.onrender.com/admin-api/users", { withCredentials: true }),
        axios.get("https://capstone-project-ycw3.onrender.com/admin-api/articles", { withCredentials: true }),
      ]);
  ...
  const toggleUserStatus = async (user) => {
    ...
    try {
      await axios.patch(
        "https://capstone-project-ycw3.onrender.com/admin-api/users",
        {
          userId: user._id,
